...
const Nav = () => {
  ...
  return (
    <>
      ...
      <nav className="w-full fixed flex flex-grow justify-between top-0 py-2 backdrop:blur-sm z-10 bg-slate-50 dark:bg-slate-900 opacity-95 lg:hidden">
      ...
      <div id='sideMenu' className={`fixed h-screen z-0 bg-slate-50 dark:bg-slate-900 opacity-95 backdrop-blur-sm transition-all duration-300 ease-out right-0 w-72 lg:hidden shadow-xl ${ menuClosed ? `hidden` : ``}`}>
        <ul className='flex flex-col list-none items-left relative p-10 mt-10 uppercase font-title text-xl opacity-100'>
          ...
          <li className='flex flex-row justify-between mt-10'>
            ...
            <a href="#" target="_blank"><FaBehance /></a>
